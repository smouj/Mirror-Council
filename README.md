...
Specialized skill for **multi-agent** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Mirror Council helps execute multi-agent tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **multi-agent** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for multi-agent scenarios.
...
**Input:** "Audit and improve multi-agent workflow."
